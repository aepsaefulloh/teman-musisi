            ...
            <div class="col-sm-7 col-xs-b10 col-sm-b0">
              ...
              <label class="checkbox-entry">
                <input type="checkbox" /><span
                  ><a href="#">Privacy policy agreement</a></span
                >
              </label>
            </div>
                ...
                <div class="swiper-container swiper-control-top">
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      ...
                      <div
                        class="product-big-preview-entry swiper-lazy"
                        data-background="~/assets/img/product-preview-4.jpg"
                      ></div>
                    </div>
                    <div class="swiper-slide">
                      <div class="swiper-lazy-preloader"></div>
                      <div
                        class="product-big-preview-entry swiper-lazy"
                        data-background="~/assets/img/product-preview-5.jpg"
                      ></div>
                    </div>
                    <div class="swiper-slide">
                      <div class="swiper-lazy-preloader"></div>
                      <div
                        class="product-big-preview-entry swiper-lazy"
                        data-background="~/assets/img/product-preview-6.jpg"
                      ></div>
                    </div>
                    <div class="swiper-slide">
                      <div class="swiper-lazy-preloader"></div>
                      <div
                        class="product-big-preview-entry swiper-lazy"
                        data-background="~/assets/img/product-preview-7.jpg"
                      ></div>
                    </div>
                    <div class="swiper-slide">
                      <div class="swiper-lazy-preloader"></div>
                      <div
                        class="product-big-preview-entry swiper-lazy"
                        data-background="~/assets/img/product-preview-8.jpg"
                      ></div>
                    </div>
                    <div class="swiper-slide">
                      <div class="swiper-lazy-preloader"></div>
                      <div
                        class="product-big-preview-entry swiper-lazy"
                        data-background="~/assets/img/product-preview-9.jpg"
                      ></div>
                    </div>
                    <div class="swiper-slide">
                      <div class="swiper-lazy-preloader"></div>
                      <div
                        class="product-big-preview-entry swiper-lazy"
                        data-background="~/assets/img/product-preview-10.jpg"
                      ></div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row col-xs-b25">
                <div class="col-sm-6">
                  <div class="simple-article size-5 grey">
                    PRICE: <span class="color">$225.00</span>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-sm-text-right">
                  <div class="simple-article size-3 col-xs-b20">
                    AVAILABLE.: <span class="grey">YES</span>
                  </div>
                </div>
              </div>
