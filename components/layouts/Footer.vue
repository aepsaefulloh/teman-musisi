  ...
  <footer>
    <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-3 col-xs-b30 col-md-b0">
            ...
            <div class="simple-article size-2 light fulltransparent">
              Integer posuere orci sit amet feugiat pellent que. Suspendisse vel
              tempor justo, sit amet posuere orci dapibus auctor
            </div>
            <div class="empty-space col-xs-b20"></div>
          ...
          <div class="col-sm-6 col-md-3 col-xs-b30 col-sm-b0">
            ...
            <div class="footer-post-preview clearfix">
              <a class="image" href="#"
                ><img src="~/assets/img/thumbnail-2.jpg" alt=""
              /></a>
              <div class="description">
                <div class="date">apr 07 / 15</div>
                <a class="title">Fusce tincidunt accumsan pretium sit amet</a>
            ...
            <div class="footer-post-preview clearfix">
              <a class="image" href="#"
                ><img src="~/assets/img/thumbnail-3.jpg" alt=""
              /></a>
              <div class="description">
                <div class="date">apr 07 / 15</div>
                <a class="title">Fusce tincidunt accumsan pretium sit amet</a>
      ...
      <div class="footer-bottom">
        <div class="row">
          <div
            class="col-lg-8 col-xs-text-center col-lg-text-left col-xs-b20 col-lg-b0"
          >
            <div class="copyright">
              &copy; 2015 All rights reserved. Development by
              <a href="http://themeforest.net/user/unionagency" target="_blank"
                >UnionAgency</a
              >
            </div>
            <div class="follow">
          ...
          <div class="col-lg-4 col-xs-text-center col-lg-text-right">
            <div class="footer-payment-icons">
              <a class="entry"
                ><img src="~/assets/img/thumbnail-4.jpg" alt=""
              /></a>
              <a class="entry"
                ><img src="~/assets/img/thumbnail-5.jpg" alt=""
              /></a>
              <a class="entry"
                ><img src="~/assets/img/thumbnail-6.jpg" alt=""
              /></a>
              <a class="entry"
                ><img src="~/assets/img/thumbnail-7.jpg" alt=""
              /></a>
              <a class="entry"
                ><img src="~/assets/img/thumbnail-8.jpg" alt=""
              /></a>
              <a class="entry"
                ><img src="~/assets/img/thumbnail-9.jpg" alt=""
              /></a>
            </div>
          </div>
        </div>
