        ...
        <div class="row">
          <div class="col-md-9 col-md-push-3">
            ...
            >
                ...
                <div class="swiper-slide">
                  <a class="product-shortcode style-2" href="#">
                    ...
                    <span class="description">
                      ...
                      <span
                        class="simple-article size-1 animate-to-fulltransparent"
                        >137 PRODUCTS</span
                      >
                    </span>
                  </a>
              ...
              <div
                class="swiper-pagination relative-pagination visible-xs"
              ></div>
            </div>
                ...
                <div class="swiper-slide">
                  <div class="banner-shortcode style-1">
                    <div
                      class="background"
                      style="
                        background-image: url(~assets/img/thumbnail-10.jpg);
                      "
                    ></div>
                    <div class="description valign-middle">
                      <div class="valign-middle-content">
                        <div
                          class="simple-article size-3 light fulltransparent"
                        >
                          DON'T MISS!
                        </div>
                ...
                <div class="swiper-slide">
                  <div class="banner-shortcode style-1">
                    <div
                      class="background"
                      style="
                        background-image: url(~assets/img/thumbnail-14.jpg);
                      "
                    ></div>
                    <div class="description valign-middle">
                      <div class="valign-middle-content">
                ...
                <div class="swiper-slide">
                  <div class="product-shortcode style-3">
                    <div class="simple-article size-5 grey col-xs-b20">
                      BEST PRICE: <span class="color">$299.00</span>
                    </div>
                      ...
                      <div class="row">
                        <div class="col-xs-6 text-left">
                          <div class="simple-article size-1">
                            AVAILABLE: <span class="grey">21</span>
                          </div>
                        </div>
                        <div class="col-xs-6 text-right">
                          <div class="simple-article size-1">
                            SOLD: <span class="grey">14</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="description">
                      <div class="simple-article size-2">
                        Penatibus nec consequat at In feugiat mole stie tortor a
                        malesuada natoque penatibus
                      </div>
                    </div>
                    <div class="empty-space col-xs-b20"></div>
          ...
          <div class="col-md-3 col-md-pull-9">
            ...
            <div class="row">
                      ...
                      <div class="banner-shortcode style-2">
                        <div class="content">
                          <div
                            class="background"
                            style="
                              background-image: url(~assets/img/thumbnail-11.jpg);
                            "
                          ></div>
                          <div class="description valign-middle">
                            <div class="valign-middle-content">
                              <div class="simple-article size-1 color">
                                <a href="#">GADGETS</a>
                              </div>
                              <div class="h4 light">
                                <a href="#">cool sport gadget</a>
                              </div>
              ...
              <div class="col-sm-6 col-md-12">
                ...
                <div class="product-shortcode style-4 clearfix">
                  <a class="preview" href="#"
                    ><img src="~/assets/img/product-29.jpg" alt=""
                  /></a>
                  <div class="description">
                    <div class="simple-article color size-1 col-xs-b5">
                      <a href="#">CASES</a>
                    ...
                    <div class="swiper-slide">
                      <div class="product-shortcode style-1 text-center">
                        <div class="title">
                          ...
                          <div class="h6 animate-to-green">
                            <a href="#">high-end spectre x360</a>
                          </div>
                        </div>
                        <div class="preview">
                          <img src="~/assets/img/product-26.jpg" alt="" />
                ...
                <div class="row m5 text-center">
                  <div class="blog-shortcode style-1">
                    <a href="#" class="preview simple-mouseover"
                      ><img src="~/assets/img/thumbnail-12.jpg" alt=""
                    /></a>
                    <div class="description">
                      <div class="simple-article size-1 grey col-xs-b5">
                        APR 07 / 15 &nbsp;&nbsp;&nbsp;<a href="#" class="color"
                          >GADGETS</a
                        >
                      </div>
                      <h6 class="h6 col-xs-b10">
                        <a href="#">Phasellus rhoncus in</a>
                      </h6>
                      <div class="simple-article size-2">
                        Etiam mollis tristique mi ac ultrices. Morbi vel neque
                        eget lacus
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="blog-shortcode style-1">
                    <a href="#" class="preview simple-mouseover"
                      ><img src="~/assets/img/thumbnail-13.jpg" alt=""
                    /></a>
                    <div class="description">
                      <div class="simple-article size-1 grey col-xs-b5">
                        APR 07 / 15 &nbsp;&nbsp;&nbsp;<a href="#" class="color"
...
<script>
import SideCategory from '@/components/layouts/SideCategory'
export default {
  components: {
    SideCategory
  },
